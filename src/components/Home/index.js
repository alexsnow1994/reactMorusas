  ...
  return (
    ...
    <h1 className='text-indigo-500'>TALLERES PRESENCIALES</h1>
     ...
     <div className='grid gap md:grid-cols-3  sm:grid-cols-1 sm: p-4 sm: m-3'>
       ...
       <div className='m-2'>
       <img className='rounded-lg p-1' src="http://drive.google.com/uc?export=view&id=1Ua-mGieDB-aU4syBdrhxes7-JfvQqNZA"/>
         
         <img className='rounded-lg p-1' src="http://drive.google.com/uc?export=view&id=1bP55lglG59TxyGowbuEg0rp9m398evd5"/>
       </div>
       <div className='m-2'>
