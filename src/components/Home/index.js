...
export default function Home() {
  ...
  <div class="md:flex">
    <div class="md:shrink-0">
      <img class="h-48 w-full object-cover md:h-full md:w-48" src="https://scontent-qro1-2.xx.fbcdn.net/v/t31.18172-8/1091036_521004354631391_519690253_o.jpg?_nc_cat=106&ccb=1-5&_nc_sid=09cbfe&_nc_eui2=AeGAnBDZRHJvSXxHg1zfA7sDbM0tsLzki3FszS2wvOSLcSf4A8PqaPMINYjZb1_c2o0LqGuqioVXb5vePsttuqRC&_nc_ohc=GZSjSG-XCSUAX_aINx3&_nc_ht=scontent-qro1-2.xx&oh=00_AT_ALjASM8WM4FblMIbm3pBdxBoXhdcncJEwSLBRFDbn_A&oe=623E0659" alt="Man looking at item at a store"/>
    </div>
    <div class="p-8">
      ...
      <p class="mt-2 text-slate-500">Getting a new business off the ground is a lot of hard work. Here are five ideas you can use to find your first customers.</p>
       ...
       <div className='border-4 border-amber-200'>3</div>
       <div className='border-4 border-amber-200 left-10 rigth-10'>4</div>
     </div>
